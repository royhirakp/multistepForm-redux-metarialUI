  ...
  return (
    <>
      ...
      >
        ...
        <TextField
          {...{ error: firstNameError, onError: ()=>{console.log('eorr on error function')}, helperText: firstNameError ? "Can't be Empty" :"" }}
          value={firstName}
          onChange={(e) => {
            if(firstNameError){
              if(e.target.value !== ""){
        ...
        <TextField
          {...{ error: lastNameError, helperText: lastNameError ? "La Can't be Empty" :"" }}
          value={lastName}
          onChange={(e) => {
            if(lastNameError){
              if(e.target.value !== ""){
        ...
        <TextField
          {...{ error: emailError, helperText: emailError ? "La Can't be Empty" :""  }}
          value={email}
          onChange={(e) => {
            if(emailError){
        ...
        // <input/>
          // hidden
          type='password'
          {...{ error: passwordError , helperText: passwordError ? "Can't be Empty" :"" }}
          // required={"hiiin error"}
          value={password}
